...
function App(props) {
    ...
    const stakerContractBalance = useBalance(
        localProvider,
        readContracts && readContracts.Staker
    ...
    const stakeEvents = useEventListener(
        readContracts,
        "Staker",
        "Stake",
        localProvider,
    ...
    const withdrawalTimeLeft = useContractReader(
        readContracts,
        "Staker",
        "withdrawalTimeLeft"
    );
